...
export interface NextGameControlsProps {
  players: PlayerInfoType[];
...
export const NextGameControls = ({
  players,
  currentGame,
  seriesState,
  nextGameAction,
  alreadyAccepted
}: NextGameControlsProps) => (
  <div class="d-flex justify-content-between align-items-center">
    <div class="d-flex flex-column align-items-left mr-1">
      <div class="font-weight-bold">
        {renderSeriesState(players, seriesState)}
      </div>
      <div>{renderEnding(players, currentGame?.ending?.ending)}</div>
    </div>
    <div class="w-25 ml-1">
